...
static void stm32f429_soc_realize(DeviceState *dev_soc, Error **errp)
{
    ...
    memory_region_add_subregion(sys_mem, FLASH_BASE_ADDRESS, &s->flash);
    memory_region_add_subregion(sys_mem, 0, &s->flash_alias);
    ...
    memory_region_add_subregion(sys_mem, SRAM_BASE_ADDRESS, &s->sram);
    ...
    memory_region_add_subregion(sys_mem, CCM_BASE_ADDRESS, &s->ccm);
...
static void stm32f429_soc_class_init(ObjectClass *class, void *data)
{
